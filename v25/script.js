// Campus Coffee Roulette — V25 (Final)
...
(function () {
  ...
  var carouselEl = document.getElementById('testimonial-carousel');
  carouselEl.addEventListener('mouseenter', function () { clearInterval(autoAdvance); });
  carouselEl.addEventListener('mouseleave', function () {
    autoAdvance = setInterval(function () { goToTestimonial(currentTestimonial + 1); }, 6000);
  });
